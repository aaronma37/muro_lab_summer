...
//"gl_FragColor = vColor;" +
    ...
    public waypoint(final Context activityContext,int j)
    {
        ...
        //Load the texture
        if (j==0){
            mTextureDataHandle = loadTexture(mActivityContext, R.drawable.waypointpoint);
        }
        else if (j==1){
            mTextureDataHandle = loadTexture(mActivityContext, R.drawable.waypointgreen);

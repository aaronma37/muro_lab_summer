...
public class distanceColorClass
{
...
//"gl_FragColor = vColor;" +
    ...
    public distanceColorClass(final Context activityContext)
    {
    ...
    public distanceColorClass(final Context activityContext, float s[], int j, float left1, float right1, float up1, float down1)
    {
        spriteCoords=s;
        mActivityContext = activityContext;
        left=left1;
        ...
        //Load the texture
        mTextureDataHandle = loadTexture(mActivityContext, R.drawable.distancecolor);


    }

    public void setOpacity(float j){
        color[3] = j;
    }
